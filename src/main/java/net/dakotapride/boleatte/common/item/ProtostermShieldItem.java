...
import net.dakotapride.boleatte.common.item.inventory.ProtostermShieldInterface;
import net.dakotapride.boleatte.common.item.inventory.RepairItemType;
...
public class ProtostermShieldItem extends Item implements ProtostermShieldInterface {
    ...
    public ProtostermShieldItem(Settings settings, int cooldownTicks, int enchantability, Item... repairItems) {
        super(settings);
    ...
    public ProtostermShieldItem(Settings settings, int cooldownTicks, ToolMaterial material) {
    ...
    public ProtostermShieldItem(Settings settings, int cooldownTicks, int enchantability, TagKey<Item> repairItemTag) {
    ...
    public ProtostermShieldItem(Settings settings, int cooldownTicks, int enchantability, Collection<TagKey<Item>> repairItemTags) {
        super(settings);
