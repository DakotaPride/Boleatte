...
public class BaburbenRootsBlock extends SweetBerryBushBlock {
    public BaburbenRootsBlock(Settings settings) {
        super(settings);
    }
    ...
    public ItemStack getPickStack(BlockView world, BlockPos pos, BlockState state) {
        return new ItemStack(ItemInit.BABURBEN);
    }
    ...
    protected boolean canPlantOnTop(BlockState floor, BlockView world, BlockPos pos) {
        return (floor.isOf(BlockInit.VIOLES) || floor.isOf(BlockInit.VETICOADE));
    }
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        ...
        if (i > 1) {
            ...
            dropStack(world, pos, new ItemStack(ItemInit.BABURBEN, j + (bl ? 1 : 0)));
