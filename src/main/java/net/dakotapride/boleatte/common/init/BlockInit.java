...
public class BlockInit {
    ...
    public static DoorBlock PROTOSTERM_DOOR = new DoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_DOOR));
    public static TrapdoorBlock PROTOSTERM_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_TRAPDOOR));
    public static SlabBlock PROTOSTERM_SLAB = new SlabBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SLAB));
    public static StairsBlock PROTOSTERM_STAIRS = new StairsBlock(PROTOSTERM_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.SPRUCE_STAIRS));
    public static FenceBlock PROTOSTERM_FENCE = new FenceBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE));
    public static FenceGateBlock PROTOSTERM_FENCE_GATE = new FenceGateBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE_GATE));
    ...
    public static DoorBlock BOTAKOA_DOOR = new DoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_DOOR));
    public static TrapdoorBlock BOTAKOA_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_TRAPDOOR));
    public static SlabBlock BOTAKOA_SLAB = new SlabBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SLAB));
    public static StairsBlock BOTAKOA_STAIRS = new StairsBlock(BOTAKOA_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.SPRUCE_STAIRS));
    public static FenceBlock BOTAKOA_FENCE = new FenceBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE));
    public static FenceGateBlock BOTAKOA_FENCE_GATE = new FenceGateBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE_GATE));
    ...
    public static DoorBlock ARBUNE_DOOR = new DoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_DOOR));
    public static TrapdoorBlock ARBUNE_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_TRAPDOOR));
    public static SlabBlock ARBUNE_SLAB = new SlabBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SLAB));
    public static StairsBlock ARBUNE_STAIRS = new StairsBlock(ARBUNE_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.SPRUCE_STAIRS));
    public static FenceBlock ARBUNE_FENCE = new FenceBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE));
    public static FenceGateBlock ARBUNE_FENCE_GATE = new FenceGateBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE_GATE));
    ...
    public static DoorBlock RASIORE_DOOR = new DoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_DOOR));
    public static TrapdoorBlock RASIORE_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_TRAPDOOR));
    public static SlabBlock RASIORE_SLAB = new SlabBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SLAB));
    public static StairsBlock RASIORE_STAIRS = new StairsBlock(RASIORE_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.SPRUCE_STAIRS));
    public static FenceBlock RASIORE_FENCE = new FenceBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE));
    public static FenceGateBlock RASIORE_FENCE_GATE = new FenceGateBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE_GATE));
    ...
    public static DoorBlock DENTICIUS_DOOR = new DoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_DOOR));
    public static TrapdoorBlock DENTICIUS_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_TRAPDOOR));
    public static SlabBlock DENTICIUS_SLAB = new SlabBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SLAB));
    public static StairsBlock DENTICIUS_STAIRS = new StairsBlock(DENTICIUS_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.SPRUCE_STAIRS));
    public static FenceBlock DENTICIUS_FENCE = new FenceBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE));
    public static FenceGateBlock DENTICIUS_FENCE_GATE = new FenceGateBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE_GATE));
    ...
    public static DoorBlock SANTIFICT_DOOR = new DoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_DOOR));
    public static TrapdoorBlock SANTIFICT_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copy(Blocks.SPRUCE_TRAPDOOR));
    public static SlabBlock SANTIFICT_SLAB = new SlabBlock(FabricBlockSettings.copy(Blocks.SPRUCE_SLAB));
    public static StairsBlock SANTIFICT_STAIRS = new StairsBlock(SANTIFICT_PLANKS.getDefaultState(), FabricBlockSettings.copy(Blocks.SPRUCE_STAIRS));
    public static FenceBlock SANTIFICT_FENCE = new FenceBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE));
    public static FenceGateBlock SANTIFICT_FENCE_GATE = new FenceGateBlock(FabricBlockSettings.copy(Blocks.SPRUCE_FENCE_GATE));
    ...
    public static void init() {
        ...
        Registry.register(Registry.BLOCK, new Identifier(ID, "arbune_stairs"), ARBUNE_STAIRS);
        Registry.register(Registry.ITEM, new Identifier(ID, "arbune_stairs"), new BlockItem(ARBUNE_STAIRS, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "arbune_slab"), ARBUNE_SLAB);
        Registry.register(Registry.ITEM, new Identifier(ID, "arbune_slab"), new BlockItem(ARBUNE_SLAB, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "arbune_door"), ARBUNE_DOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "arbune_door"), new BlockItem(ARBUNE_DOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "arbune_trapdoor"), ARBUNE_TRAPDOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "arbune_trapdoor"), new BlockItem(ARBUNE_TRAPDOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "arbune_fence"), ARBUNE_FENCE);
        Registry.register(Registry.ITEM, new Identifier(ID, "arbune_fence"), new BlockItem(ARBUNE_FENCE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "arbune_fence_gate"), ARBUNE_FENCE_GATE);
        Registry.register(Registry.ITEM, new Identifier(ID, "arbune_fence_gate"), new BlockItem(ARBUNE_FENCE_GATE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));

        Registry.register(Registry.BLOCK, new Identifier(ID, "protosterm_stairs"), PROTOSTERM_STAIRS);
        Registry.register(Registry.ITEM, new Identifier(ID, "protosterm_stairs"), new BlockItem(PROTOSTERM_STAIRS, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "protosterm_slab"), PROTOSTERM_SLAB);
        Registry.register(Registry.ITEM, new Identifier(ID, "protosterm_slab"), new BlockItem(PROTOSTERM_SLAB, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "protosterm_door"), PROTOSTERM_DOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "protosterm_door"), new BlockItem(PROTOSTERM_DOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "protosterm_trapdoor"), PROTOSTERM_TRAPDOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "protosterm_trapdoor"), new BlockItem(PROTOSTERM_TRAPDOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "protosterm_fence"), PROTOSTERM_FENCE);
        Registry.register(Registry.ITEM, new Identifier(ID, "protosterm_fence"), new BlockItem(PROTOSTERM_FENCE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "protosterm_fence_gate"), PROTOSTERM_FENCE_GATE);
        Registry.register(Registry.ITEM, new Identifier(ID, "protosterm_fence_gate"), new BlockItem(PROTOSTERM_FENCE_GATE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));

        Registry.register(Registry.BLOCK, new Identifier(ID, "botakoa_stairs"), BOTAKOA_STAIRS);
        Registry.register(Registry.ITEM, new Identifier(ID, "botakoa_stairs"), new BlockItem(BOTAKOA_STAIRS, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "botakoa_slab"), BOTAKOA_SLAB);
        Registry.register(Registry.ITEM, new Identifier(ID, "botakoa_slab"), new BlockItem(BOTAKOA_SLAB, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "botakoa_door"), BOTAKOA_DOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "botakoa_door"), new BlockItem(BOTAKOA_DOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "botakoa_trapdoor"), BOTAKOA_TRAPDOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "botakoa_trapdoor"), new BlockItem(BOTAKOA_TRAPDOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "botakoa_fence"), BOTAKOA_FENCE);
        Registry.register(Registry.ITEM, new Identifier(ID, "botakoa_fence"), new BlockItem(BOTAKOA_FENCE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "botakoa_fence_gate"), BOTAKOA_FENCE_GATE);
        Registry.register(Registry.ITEM, new Identifier(ID, "botakoa_fence_gate"), new BlockItem(BOTAKOA_FENCE_GATE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));

        Registry.register(Registry.BLOCK, new Identifier(ID, "denticius_stairs"), DENTICIUS_STAIRS);
        Registry.register(Registry.ITEM, new Identifier(ID, "denticius_stairs"), new BlockItem(DENTICIUS_STAIRS, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "denticius_slab"), DENTICIUS_SLAB);
        Registry.register(Registry.ITEM, new Identifier(ID, "denticius_slab"), new BlockItem(DENTICIUS_SLAB, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "denticius_door"), DENTICIUS_DOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "denticius_door"), new BlockItem(DENTICIUS_DOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "denticius_trapdoor"), DENTICIUS_TRAPDOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "denticius_trapdoor"), new BlockItem(DENTICIUS_TRAPDOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "denticius_fence"), DENTICIUS_FENCE);
        Registry.register(Registry.ITEM, new Identifier(ID, "denticius_fence"), new BlockItem(DENTICIUS_FENCE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "denticius_fence_gate"), DENTICIUS_FENCE_GATE);
        Registry.register(Registry.ITEM, new Identifier(ID, "denticius_fence_gate"), new BlockItem(DENTICIUS_FENCE_GATE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));

        Registry.register(Registry.BLOCK, new Identifier(ID, "rasiore_stairs"), RASIORE_STAIRS);
        Registry.register(Registry.ITEM, new Identifier(ID, "rasiore_stairs"), new BlockItem(RASIORE_STAIRS, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "rasiore_slab"), RASIORE_SLAB);
        Registry.register(Registry.ITEM, new Identifier(ID, "rasiore_slab"), new BlockItem(RASIORE_SLAB, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "rasiore_door"), RASIORE_DOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "rasiore_door"), new BlockItem(RASIORE_DOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "rasiore_trapdoor"), RASIORE_TRAPDOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "rasiore_trapdoor"), new BlockItem(RASIORE_TRAPDOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "rasiore_fence"), RASIORE_FENCE);
        Registry.register(Registry.ITEM, new Identifier(ID, "rasiore_fence"), new BlockItem(RASIORE_FENCE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "rasiore_fence_gate"), RASIORE_FENCE_GATE);
        Registry.register(Registry.ITEM, new Identifier(ID, "rasiore_fence_gate"), new BlockItem(RASIORE_FENCE_GATE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));

        Registry.register(Registry.BLOCK, new Identifier(ID, "santifict_stairs"), SANTIFICT_STAIRS);
        Registry.register(Registry.ITEM, new Identifier(ID, "santifict_stairs"), new BlockItem(SANTIFICT_STAIRS, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "santifict_slab"), SANTIFICT_SLAB);
        Registry.register(Registry.ITEM, new Identifier(ID, "santifict_slab"), new BlockItem(SANTIFICT_SLAB, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "santifict_door"), SANTIFICT_DOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "santifict_door"), new BlockItem(SANTIFICT_DOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "santifict_trapdoor"), SANTIFICT_TRAPDOOR);
        Registry.register(Registry.ITEM, new Identifier(ID, "santifict_trapdoor"), new BlockItem(SANTIFICT_TRAPDOOR, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "santifict_fence"), SANTIFICT_FENCE);
        Registry.register(Registry.ITEM, new Identifier(ID, "santifict_fence"), new BlockItem(SANTIFICT_FENCE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
        Registry.register(Registry.BLOCK, new Identifier(ID, "santifict_fence_gate"), SANTIFICT_FENCE_GATE);
        Registry.register(Registry.ITEM, new Identifier(ID, "santifict_fence_gate"), new BlockItem(SANTIFICT_FENCE_GATE, new FabricItemSettings().group(ItemInit.BoleatteItemGroup.BOLEATTE)));
